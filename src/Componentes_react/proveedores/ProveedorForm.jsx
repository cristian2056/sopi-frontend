      ...
      <div style={{ maxWidth: 580, width: "100%" }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 14 }}>
            ...
            <div>
              <label htmlFor="pf-calificacion" style={labelSt}>Calificación (1–5)</label>
              <input id="pf-calificacion" type="number" min={1} max={5} placeholder="1 a 5"
                value={form.calificacion}
                onChange={e => {
                  const v = e.target.value;
                  if (v === "" || (Number(v) >= 1 && Number(v) <= 5)) set("calificacion", v);
                }}
                style={inputSt} />
            </div>
          </div>
